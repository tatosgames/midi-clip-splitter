...
const Index = () => {
  ...
  const handleFileSelect = async (file: File) => {
    ...
    try {
      ...
      setSplitSettings(prev => ({ ...prev, ppq: parsed.header.ppq }));
    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-accent/5">
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        ...
        <header className="mb-12 text-center">
          <div className="flex items-center justify-center gap-3 mb-4">
            <div className="relative">
              ...
              <Disc3 className="w-12 h-12 text-primary relative z-10 animate-spin" style={{ animationDuration: '8s' }} />
            </div>
            <h1 className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-primary to-primary/60 bg-clip-text text-transparent">
              MC-101 MIDI Splitter
            </h1>
          </div>
          <p className="text-muted-foreground max-w-2xl mx-auto">
            Prepare your MIDI patterns as MC-101 ready clips in a single zip. 
            Upload, map tracks, and export with automatic 128-step splitting.
          </p>
        </header>
        ...
        <footer className="mt-16 text-center text-sm text-muted-foreground">
          <p>
            Optimized for Roland MC-101 • Maximum 128 steps per clip • SMF Type 1 export
          </p>
        </footer>
      </div>
    </div>
